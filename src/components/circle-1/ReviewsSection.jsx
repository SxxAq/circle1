    ...
    <section className="flex flex-col items-center self-center mt-32 max-w-full text-stone-900 w-[1280px] max-md:mt-10">
            ...
            <div className="flex flex-col mt-6 w-full max-md:max-w-full">
              <div className="flex gap-6 items-center self-start">
                <div className="flex gap-1 items-start self-stretch my-auto">
                  {[...Array(5)].map((_, i) => (
                    <img key={i} loading="lazy" src={i < review.rating ? "https://cdn.builder.io/api/v1/image/assets/TEMP/9e228c1c810647524b745101ed452e5e2dec1457cbbde3d3d36412b7f532925c?apiKey=95b7b2aa9950440b926ba3614b9a318a&" : "https://cdn.builder.io/api/v1/image/assets/TEMP/1072b6bb0e04f0b5a258d402eb0859c5781c5bf8f836292a963767f454d72bab?apiKey=95b7b2aa9950440b926ba3614b9a318a&"} className="object-contain shrink-0 w-4 aspect-square" alt="" />
                  ))}
                </div>
                <div className="self-stretch my-auto text-base leading-relaxed text-neutral-800">{review.title}</div>
              </div>
              <p className="mt-3 text-sm tracking-normal leading-6 opacity-80 text-stone-500 max-md:max-w-full">{review.content}</p>
            </div>
          </div>
        ))}
      </div>
      <button className="flex flex-col justify-center items-start py-0.5 mt-9 text-base font-medium tracking-tight leading-tight text-center text-neutral-900 w-[93px]">
        <div className="flex gap-1 items-start max-md:mr-0">
          <span>Read More</span>
          <img loading="lazy" src="https://cdn.builder.io/api/v1/image/assets/TEMP/e122f681df43b818b9e7bc5fa687ce26e09ad3805b7157722da825b883eac49f?apiKey=95b7b2aa9950440b926ba3614b9a318a&" className="object-contain shrink-0 aspect-square w-[19px]" alt="" />
        </div>
      </button>
    </section>
  );

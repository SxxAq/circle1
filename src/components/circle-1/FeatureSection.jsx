  ...
  const features = [
    {
      ...
      description: "Experience the unique round screen design - a blend of sleek aesthetics and cutting-edge functionality.",
    ...
    },
    {
      ...
      description: "itel Circle 1 features an inbuilt BT caller, ensuring seamless connectivity on the go. Take calls from your other devices directly on the Circle 1.",
    ...
    },
    {
      ...
      description: "Easily carry your device with the included lanyard for hands-free convenience wherever you go.",
        ...
        {features.map((feature, index) => (
          <div key={index} className="flex flex-col justify-center min-w-[240px] w-[340px]">
            ...
            <div className="flex flex-col justify-center mt-4 w-full">
              <h3 className="text-2xl font-medium tracking-tight leading-8 text-neutral-900">{feature.title}</h3>
              <p className="mt-4 text-base leading-7 opacity-70 text-neutral-800">{feature.description}</p>
            </div>
          </div>
        ))}
      </div>
